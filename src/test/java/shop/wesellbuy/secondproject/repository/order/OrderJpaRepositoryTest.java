...
//    @Rollback(value = false)
    ...
    @Test
//    @Rollback(value = false)
    public void 주문_모두_가져오기_By_조건_페이징() {
        // given
        // 페이지, 사이즈 정하기
...
//        testResult(pageablePage0Size10, cond2, oCount + oCount2 + oCount3);
//        testResult(pageablePage0Size10, cond3, oCount + oCount2 + oCount3);
//        testResult(pageablePage0Size10, cond4, oCount + oCount2 + oCount3);
        // 조건 2
//        testResult(pageablePage0Size10, cond21, oCount2);
//        testResult(pageablePage0Size10, cond22, oCount);
//        testResult(pageablePage0Size10, cond23, oCount);
//        testResult(pageablePage0Size10, cond24, oCount + oCount2 + oCount3);
//        testResult(pageablePage0Size10, cond25, oCount + oCount2 + oCount3);
//        testResult(pageablePage0Size10, cond26, oCount + oCount2 + oCount3);
        // 조건 3
...
//        testResult(pageablePage3Size5, cond34, oCount + oCount2 + oCount3);
        // 조건 4
        testResult(pageablePage3Size5, cond41, oCount3);


        // 검색에 대한 result가 없는 경우
//        testResult(pageablePage0Size10, cond5, oCount + oCount2 + oCount3);
